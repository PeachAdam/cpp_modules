...
/*   Updated: 2022/11/21 15:34:10 by yaysu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form()
	:	name("Form"), grade_sign(150), grade_exec(150), is_signed(false)
{
}
...
void Form::beSigned(const Bureaucrat &target){
    ...
    {
		std::cout << target.getName() << " signed " << this->getName() << " named form." << std::endl;
        this->is_signed = true;
    }
    else
        throw Form::GradeTooLowException();
